/**
 * ApiKeyService.js
 * LocalStorage first, fallback to env.
 */
...
export const ApiKeyService = {
  ...
  setApiKey(k) { if (typeof window !== "undefined" && window.localStorage) { window.localStorage.setItem(STORAGE_KEY, k); return true; } return false; },
